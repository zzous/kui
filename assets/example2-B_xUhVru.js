import{r as y,g as s,e as o,f as t,i as C,x as c,t as r,F as v,j as h,n as g}from"./index-CKCqUIez.js";const b={class:"guidecontent"},x={class:"guidetitle"},N=["onClick"],S=["onClick"],P={__name:"example2",props:{sampleProps:{type:Object,default:()=>{}}},setup(u){const n=y({className:"",codeSample:[{title:"HTML",sampleCodeJS:`<ListTable 
    :selected="true"
    :downLoad="true"
